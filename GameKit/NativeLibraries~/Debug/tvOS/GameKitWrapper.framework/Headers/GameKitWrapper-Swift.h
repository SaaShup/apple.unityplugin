...
SWIFT_EXTERN BOOL GKAccessPoint_GetIsFocused(void * _Nonnull pointer) SWIFT_NOEXCEPT SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_EXTERN float GKAchievement_GetPercentComplete(GKAchievement * _Nonnull * _Nonnull pointer) SWIFT_NOEXCEPT SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_EXTERN void GKAchievement_SetPercentComplete(GKAchievement * _Nonnull * _Nonnull pointer, float value) SWIFT_NOEXCEPT;
...
SWIFT_EXTERN void GKLeaderboard_LoadLeaderboards(NSArray * _Nonnull * _Nullable pointer, int64_t taskId, void (* _Nonnull onSuccess)(int64_t, void * _Nullable), void (* _Nonnull onError)(int64_t, NSError * _Nonnull * _Nonnull)) SWIFT_NOEXCEPT;
...
@class GKWMatchmakerViewControllerDelegate;
...
@class GKWTurnBasedMatchmakerViewControllerDelegate;
